...
class WalletConnectWallet {
  ...
  async executeContractFunction(contractId, functionName, functionParameters, gasLimit) {
    // Accept both EVM addresses (0x...) and Hedera contract IDs (0.0.XXXX)
    const contractIdObj = typeof contractId === 'string' && contractId.startsWith('0x')
      ? ContractId.fromEvmAddress(0, 0, contractId.slice(2))
      : ContractId.fromString(contractId.toString());
